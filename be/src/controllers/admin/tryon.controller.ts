 ...
 */
export const setTryonEndpoint = catchAsync(
  async (req: Request, res: Response) => {
    const { base_url, shared_secret } = req.body as {
      base_url: string;
 ...
 */
export const getTryonEndpoint = catchAsync(
  async (_req: Request, res: Response) => {
    const { base_url, last_health_check_at, last_health_check_ok } =
      tryonConfig.getEndpoint();
